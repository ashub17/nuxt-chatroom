  ...
  <UCard class="" :ui="{ body: { padding: 'p-0 sm:p-0' } }">
    <template #header>
      <div class="flex items-center justify-between text-primary">
        <div class="flex items-center gap-x-2">
          ...
          />
          <div class="text-primary font-semibold text-center text-xl">Nuxt Chatroom</div>
        </div>
        <div
          @click="() => navigateTo('/')"
          class="bg-red-600 px-3 py-1.5 text-white cursor-pointer"
        >
    ...
    <div class="flex">
      ...
      <div class="bg-slate-100 py-4 px-6">
        <div class="mb-4">
          <div class="flex items-center gap-x-2 mb-2 px-3 py-1.5 rounded-md bg-primary">
            <UIcon
      ...
      <div class="h-96 overflow-y-auto px-8 py-10 flex-1">
        <div
          ...
          :key="i"
          :class="{
            'justify-center': chat.username === 'Chatroom Admin',
        ...
        >
          <div
            ...
            :class="{
              'bg-red-500': chat.username === 'Chatroom Admin',
              'bg-primary/20': chat.username === route.query.username,
              'bg-blue-800': chat.username !== route.query.username,
            }"
          >
